@props(['id', 'title', 'confirmLabel' => __('admin.actions.confirm'), 'variant' => 'danger'])
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ __('admin.actions.cancel') }}</button>
                @isset($confirm)
                    {{ $confirm }}
                @endisset
            </div>
