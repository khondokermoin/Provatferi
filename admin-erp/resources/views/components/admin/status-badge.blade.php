...
@php
    ...
    $map = [
        ...
        'contacted' => ['bg-info-subtle text-info-emphasis', 'ti-phone-call'],
        'accepted' => ['bg-success-subtle text-success-emphasis', 'ti-circle-check'],
        'not_selected' => ['bg-secondary-subtle text-secondary-emphasis', 'ti-circle-minus'],
        'withdrawn' => ['bg-secondary-subtle text-secondary-emphasis', 'ti-arrow-back-up'],
